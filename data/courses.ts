...
export const courses: Course[] = [
  ...
  {
    id: "wireless-lan",
    title: "Wireless LAN (Wi-Fi) Fundamentals",
    description: "เรียนรู้ 802.11 standards, WPA3, roaming, RF design และการกำหนดค่า Cisco WLC",
    level: "Intermediate",
    duration: "14 hours",
    category: "Wireless",
    thumbnail: "📡",
    ...
    modules: [
      {
        id: "wlan-m1",
        title: "802.11 Standards & Frequencies",
        duration: "2.5 hours",
        lessons: [
          { id: "wl-l1", title: "Wi-Fi Standards: a/b/g/n/ac/ax", duration: "25 min", type: "video" as const, completed: false },
          { id: "wl-l2", title: "2.4 GHz vs 5 GHz vs 6 GHz", duration: "20 min", type: "video" as const, completed: false },
          { id: "wl-l3", title: "CSMA/CA & Hidden Node", duration: "20 min", type: "video" as const, completed: false },
          { id: "wl-l4", title: "Channel Planning Lab", duration: "45 min", type: "lab" as const, completed: false },
        ],
      },
      {
        id: "wlan-m2",
        title: "Security: WPA2/WPA3 & 802.1X",
        duration: "3 hours",
        lessons: [
          { id: "wl-l5", title: "WPA2 PSK vs Enterprise", duration: "25 min", type: "video" as const, completed: false },
          { id: "wl-l6", title: "WPA3 SAE & OWE", duration: "20 min", type: "video" as const, completed: false },
          { id: "wl-l7", title: "802.1X EAP Methods", duration: "30 min", type: "video" as const, completed: false },
          { id: "wl-l8", title: "RADIUS Integration Lab", duration: "60 min", type: "lab" as const, completed: false },
        ],
      },
      {
        id: "wlan-m3",
        title: "Cisco WLC & FlexConnect",
        duration: "3 hours",
        lessons: [
          { id: "wl-l9", title: "WLC Architecture & CAPWAP", duration: "25 min", type: "video" as const, completed: false },
          { id: "wl-l10", title: "AP Modes: Local, FlexConnect, Monitor", duration: "20 min", type: "video" as const, completed: false },
          { id: "wl-l11", title: "WLC Configuration Lab", duration: "75 min", type: "lab" as const, completed: false },
          { id: "wl-l12", title: "Wireless Quiz", duration: "20 min", type: "quiz" as const, completed: false },
        ],
      },
    ],
    prerequisites: ["ccna-complete"],
    skills: ["Wi-Fi 6/6E", "WPA3", "Cisco WLC", "RF Design", "802.1X"],
    relatedLabs: [],
    relatedQuizzes: [],
  },
  {
    id: "network-security-core",
    title: "Network Security Essentials",
    description: "Firewall, ACL, AAA, IPS/IDS, VPN fundamentals และ Zero Trust principles สำหรับ Network Engineer",
    level: "Intermediate",
    duration: "16 hours",
    category: "Security",
    thumbnail: "🔒",
    ...
    modules: [
      {
        id: "sec-m1",
        title: "Access Control & Firewall",
        duration: "4 hours",
        lessons: [
          { id: "sec-l1", title: "Stateless vs Stateful Firewall", duration: "25 min", type: "video" as const, completed: false },
          { id: "sec-l2", title: "Cisco ASA Zones & Policy", duration: "30 min", type: "video" as const, completed: false },
          { id: "sec-l3", title: "Extended ACL Best Practices", duration: "25 min", type: "video" as const, completed: false },
          { id: "sec-l4", title: "ASA Firewall Lab", duration: "90 min", type: "lab" as const, completed: false },
        ],
      },
      {
        id: "sec-m2",
        ...
        duration: "3 hours",
        lessons: [
          { id: "sec-l5", title: "AAA: Authentication, Authorization, Accounting", duration: "25 min", type: "video" as const, completed: false },
          { id: "sec-l6", title: "RADIUS vs TACACS+", duration: "20 min", type: "video" as const, completed: false },
          { id: "sec-l7", title: "Cisco ISE Overview", duration: "25 min", type: "video" as const, completed: false },
          { id: "sec-l8", title: "AAA Lab", duration: "60 min", type: "lab" as const, completed: false },
        ],
      },
      {
        id: "sec-m3",
        title: "Threat Defense & Zero Trust",
        duration: "3 hours",
        lessons: [
          { id: "sec-l9", title: "IPS/IDS Signatures & Tuning", duration: "25 min", type: "video" as const, completed: false },
          { id: "sec-l10", title: "Zero Trust Architecture", duration: "20 min", type: "video" as const, completed: false },
          { id: "sec-l11", title: "Security Hardening Checklist", duration: "25 min", type: "video" as const, completed: false },
          { id: "sec-l12", title: "Security Assessment Quiz", duration: "20 min", type: "quiz" as const, completed: false },
        ],
      },
    ],
    prerequisites: ["ccna-complete"],
    skills: ["Firewall", "ACL", "AAA/RADIUS", "IPS/IDS", "Zero Trust", "Cisco ISE"],
    relatedLabs: [],
    relatedQuizzes: [],
  },
  {
    id: "ipsec-vpn",
    title: "IPsec & VPN Technologies",
    description: "Site-to-Site IPsec VPN, Remote Access VPN, IKEv2/IKEv1, DMVPN และ FlexVPN บน Cisco IOS",
    level: "Advanced",
    duration: "15 hours",
    category: "Security",
    thumbnail: "🔐",
    ...
    modules: [
      {
        ...
        duration: "3.5 hours",
        lessons: [
          { id: "vpn-l1", title: "IPsec Protocol Suite: AH, ESP", duration: "25 min", type: "video" as const, completed: false },
          { id: "vpn-l2", title: "IKEv1 vs IKEv2 Negotiation", duration: "30 min", type: "video" as const, completed: false },
          { id: "vpn-l3", title: "Crypto Maps & Transform Sets", duration: "25 min", type: "video" as const, completed: false },
          { id: "vpn-l4", title: "Site-to-Site IPsec Lab", duration: "90 min", type: "lab" as const, completed: false },
        ],
      },
      {
        id: "vpn-m2",
        title: "DMVPN (Hub-and-Spoke & Full Mesh)",
        duration: "4 hours",
        lessons: [
          { id: "vpn-l5", title: "DMVPN Phases 1, 2, 3", duration: "30 min", type: "video" as const, completed: false },
          { id: "vpn-l6", title: "mGRE & NHRP", duration: "25 min", type: "video" as const, completed: false },
          { id: "vpn-l7", title: "DMVPN + OSPF/EIGRP", duration: "30 min", type: "video" as const, completed: false },
          { id: "vpn-l8", title: "DMVPN Lab", duration: "90 min", type: "lab" as const, completed: false },
        ],
      },
      {
        id: "vpn-m3",
        title: "Remote Access & FlexVPN",
        duration: "3 hours",
        lessons: [
          { id: "vpn-l9", title: "AnyConnect SSL VPN", duration: "25 min", type: "video" as const, completed: false },
          { id: "vpn-l10", title: "FlexVPN with IKEv2", duration: "30 min", type: "video" as const, completed: false },
          { id: "vpn-l11", title: "VPN Troubleshooting", duration: "25 min", type: "video" as const, completed: false },
          { id: "vpn-l12", title: "VPN Quiz", duration: "20 min", type: "quiz" as const, completed: false },
        ],
      },
    ],
    prerequisites: ["network-security-core"],
    skills: ["IPsec", "IKEv2", "DMVPN", "FlexVPN", "AnyConnect", "mGRE/NHRP"],
    relatedLabs: ["gre-tunnel-lab"],
    relatedQuizzes: [],
  },
  {
    id: "cloud-networking",
    title: "Cloud Networking (AWS & Azure)",
    description: "VPC, VNet, Transit Gateway, ExpressRoute, hybrid connectivity และ cloud-native load balancing",
    level: "Advanced",
    duration: "14 hours",
    category: "Cloud",
    thumbnail: "☁️",
    ...
    modules: [
      {
        ...
        duration: "4 hours",
        lessons: [
          { id: "cl-l1", title: "VPC, Subnets, Route Tables", duration: "30 min", type: "video" as const, completed: false },
          { id: "cl-l2", title: "Security Groups vs NACLs", duration: "20 min", type: "video" as const, completed: false },
          { id: "cl-l3", title: "Transit Gateway & VPC Peering", duration: "25 min", type: "video" as const, completed: false },
          { id: "cl-l4", title: "Direct Connect & Site-to-Site VPN", duration: "25 min", type: "video" as const, completed: false },
          { id: "cl-l5", title: "AWS VPC Lab", duration: "75 min", type: "lab" as const, completed: false },
        ],
      },
      {
        id: "cloud-m2",
        ...
        duration: "4 hours",
        lessons: [
          { id: "cl-l6", title: "Azure VNet & Peering", duration: "25 min", type: "video" as const, completed: false },
          { id: "cl-l7", title: "ExpressRoute vs VPN Gateway", duration: "25 min", type: "video" as const, completed: false },
          { id: "cl-l8", title: "Azure Firewall & NSG", duration: "25 min", type: "video" as const, completed: false },
          { id: "cl-l9", title: "Azure Hub-Spoke Lab", duration: "75 min", type: "lab" as const, completed: false },
        ],
      },
      {
        id: "cloud-m3",
        title: "Hybrid Cloud & Load Balancing",
        duration: "3 hours",
        lessons: [
          { id: "cl-l10", title: "Cloud Load Balancers: ALB, NLB, Azure LB", duration: "25 min", type: "video" as const, completed: false },
          { id: "cl-l11", title: "DNS in the Cloud: Route53 & Azure DNS", duration: "20 min", type: "video" as const, completed: false },
          { id: "cl-l12", title: "Multi-Cloud Strategy", duration: "20 min", type: "video" as const, completed: false },
          { id: "cl-l13", title: "Cloud Networking Quiz", duration: "20 min", type: "quiz" as const, completed: false },
        ],
      },
    ],
    prerequisites: ["network-automation"],
    skills: ["AWS VPC", "Azure VNet", "Transit Gateway", "ExpressRoute", "Direct Connect", "Cloud Firewall"],
    relatedLabs: [],
    relatedQuizzes: [],
  },
  ...
  {
    id: "bgp-advanced",
    title: "BGP Advanced & Internet Routing",
    description: "BGP path selection, communities, Route Reflectors, Confederations, prefix filtering และ Internet peering design",
    level: "Advanced",
    duration: "18 hours",
    category: "Routing",
    thumbnail: "🌐",
    ...
    modules: [
      {
        id: "bgp-m1",
        title: "BGP Path Selection Deep Dive",
        duration: "4 hours",
        lessons: [
          { id: "bgp-l1", title: "BGP Best Path Algorithm (12 Steps)", duration: "35 min", type: "video" as const, completed: false },
          { id: "bgp-l2", title: "Weight & Local Preference", duration: "25 min", type: "video" as const, completed: false },
          { id: "bgp-l3", title: "AS Path Prepending", duration: "20 min", type: "video" as const, completed: false },
          { id: "bgp-l4", title: "MED & Origin Attribute", duration: "20 min", type: "video" as const, completed: false },
          { id: "bgp-l5", title: "BGP Path Selection Lab", duration: "75 min", type: "lab" as const, completed: false },
        ],
      },
      {
        id: "bgp-m2",
        title: "Scaling iBGP: RR & Confederation",
        duration: "4 hours",
        lessons: [
          { id: "bgp-l6", title: "Route Reflector Design", duration: "30 min", type: "video" as const, completed: false },
          { id: "bgp-l7", title: "BGP Confederation", duration: "25 min", type: "video" as const, completed: false },
          { id: "bgp-l8", title: "Cluster List & Originator ID", duration: "20 min", type: "video" as const, completed: false },
          { id: "bgp-l9", title: "Route Reflector Lab", duration: "80 min", type: "lab" as const, completed: false },
        ],
      },
      {
        id: "bgp-m3",
        ...
        duration: "4 hours",
        lessons: [
          { id: "bgp-l10", title: "Well-Known Communities: no-export, no-advertise", duration: "25 min", type: "video" as const, completed: false },
          { id: "bgp-l11", title: "Extended Communities & Large Communities", duration: "20 min", type: "video" as const, completed: false },
          { id: "bgp-l12", title: "Prefix Filtering & Route Maps", duration: "30 min", type: "video" as const, completed: false },
          { id: "bgp-l13", title: "BGP Policy Lab", duration: "80 min", type: "lab" as const, completed: false },
          { id: "bgp-l14", title: "BGP Advanced Quiz", duration: "20 min", type: "quiz" as const, completed: false },
        ],
      },
    ],
    prerequisites: ["bgp-routing"],
    skills: ["BGP Path Selection", "Route Reflector", "BGP Communities", "Prefix Filtering", "Internet Peering"],
    relatedLabs: ["bgp-basic-lab"],
    relatedQuizzes: [],
  },
  {
    id: "data-center-networking",
    title: "Data Center Networking (Spine-Leaf)",
    description: "สถาปัตยกรรม Data Center สมัยใหม่: Spine-Leaf, VXLAN, EVPN, BGP ECMP และ Cisco ACI overview",
    level: "Advanced",
    duration: "16 hours",
    ...
    modules: [
      {
        ...
        duration: "3.5 hours",
        lessons: [
          { id: "dc-l1", title: "3-Tier vs Spine-Leaf Architecture", duration: "30 min", type: "video" as const, completed: false },
          { id: "dc-l2", title: "ECMP Load Balancing in Fabric", duration: "25 min", type: "video" as const, completed: false },
          { id: "dc-l3", title: "Oversubscription Ratios", duration: "20 min", type: "video" as const, completed: false },
          { id: "dc-l4", title: "DC Topology Design Lab", duration: "60 min", type: "lab" as const, completed: false },
        ],
      },
      {
        id: "dc-m2",
        ...
        duration: "5 hours",
        lessons: [
          { id: "dc-l5", title: "VXLAN Fundamentals & VNI", duration: "30 min", type: "video" as const, completed: false },
          { id: "dc-l6", title: "VTEP (Virtual Tunnel Endpoint)", duration: "25 min", type: "video" as const, completed: false },
          { id: "dc-l7", title: "BGP EVPN Control Plane", duration: "35 min", type: "video" as const, completed: false },
          { id: "dc-l8", title: "Distributed Anycast Gateway", duration: "20 min", type: "video" as const, completed: false },
          { id: "dc-l9", title: "VXLAN/EVPN Lab", duration: "90 min", type: "lab" as const, completed: false },
        ],
      },
      {
        id: "dc-m3",
        title: "Cisco ACI & Automation",
        duration: "4 hours",
        lessons: [
          { id: "dc-l10", title: "ACI Concepts: Tenant, VRF, BD, EPG", duration: "30 min", type: "video" as const, completed: false },
          { id: "dc-l11", title: "ACI Policy Model", duration: "25 min", type: "video" as const, completed: false },
          { id: "dc-l12", title: "DC Automation with Ansible/Terraform", duration: "30 min", type: "video" as const, completed: false },
          { id: "dc-l13", title: "Data Center Quiz", duration: "20 min", type: "quiz" as const, completed: false },
        ],
      },
    ],
    prerequisites: ["mpls-qos", "network-automation"],
    skills: ["Spine-Leaf", "VXLAN", "BGP EVPN", "Cisco ACI", "DC Automation"],
    relatedLabs: [],
    relatedQuizzes: [],
  },
  {
    id: "sdn-openflow",
    title: "SDN & OpenFlow / Cisco DNA Center",
    description: "Software-Defined Networking concepts, OpenFlow protocol, Cisco DNA Center, Intent-Based Networking",
    level: "Advanced",
    duration: "13 hours",
    category: "SDN",
    thumbnail: "🧠",
    ...
    modules: [
      {
        ...
        duration: "3 hours",
        lessons: [
          { id: "sdn-l1", title: "Control Plane vs Data Plane Separation", duration: "25 min", type: "video" as const, completed: false },
          { id: "sdn-l2", title: "OpenFlow Protocol Deep Dive", duration: "30 min", type: "video" as const, completed: false },
          { id: "sdn-l3", title: "SDN Controllers: ONOS, OpenDaylight", duration: "25 min", type: "video" as const, completed: false },
          { id: "sdn-l4", title: "OpenFlow Lab (Mininet)", duration: "60 min", type: "lab" as const, completed: false },
        ],
      },
      {
        id: "sdn-m2",
        title: "Cisco DNA Center & IBN",
        duration: "4 hours",
        lessons: [
          { id: "sdn-l5", title: "Intent-Based Networking (IBN)", duration: "25 min", type: "video" as const, completed: false },
          { id: "sdn-l6", title: "Cisco DNA Center Architecture", duration: "30 min", type: "video" as const, completed: false },
          { id: "sdn-l7", title: "DNA Center REST API", duration: "30 min", type: "video" as const, completed: false },
          { id: "sdn-l8", title: "SD-Access Fabric", duration: "25 min", type: "video" as const, completed: false },
          { id: "sdn-l9", title: "DNA Center API Lab", duration: "60 min", type: "lab" as const, completed: false },
        ],
      },
      {
        id: "sdn-m3",
        ...
        duration: "3 hours",
        lessons: [
          { id: "sdn-l10", title: "NETCONF & YANG Models", duration: "25 min", type: "video" as const, completed: false },
          { id: "sdn-l11", title: "gRPC & gNMI for Telemetry", duration: "20 min", type: "video" as const, completed: false },
          { id: "sdn-l12", title: "SDN Quiz", duration: "20 min", type: "quiz" as const, completed: false },
        ],
      },
    ],
    prerequisites: ["network-automation"],
    skills: ["OpenFlow", "SDN Controllers", "Cisco DNA Center", "IBN", "NETCONF", "gNMI"],
    relatedLabs: [],
    relatedQuizzes: [],
  },
  {
    id: "iot-networking",
    title: "IoT Networking & Edge Computing",
    description: "IoT protocols (MQTT, CoAP, Zigbee), network design สำหรับ IoT, Edge Computing และ security สำหรับ connected devices",
    level: "Intermediate",
    duration: "12 hours",
    category: "IoT",
    thumbnail: "📱",
    ...
    modules: [
      {
        ...
        duration: "3.5 hours",
        lessons: [
          { id: "iot-l1", title: "MQTT: Pub/Sub Architecture", duration: "25 min", type: "video" as const, completed: false },
          { id: "iot-l2", title: "CoAP vs HTTP for IoT", duration: "20 min", type: "video" as const, completed: false },
          { id: "iot-l3", title: "Zigbee, Z-Wave, LoRaWAN", duration: "25 min", type: "video" as const, completed: false },
          { id: "iot-l4", title: "MQTT Broker Lab", duration: "60 min", type: "lab" as const, completed: false },
        ],
      },
      {
        id: "iot-m2",
        ...
        duration: "3 hours",
        lessons: [
          { id: "iot-l5", title: "IoT Network Segmentation & VLAN", duration: "25 min", type: "video" as const, completed: false },
          { id: "iot-l6", title: "Edge Computing vs Cloud", duration: "20 min", type: "video" as const, completed: false },
          { id: "iot-l7", title: "Fog Computing Architecture", duration: "20 min", type: "video" as const, completed: false },
          { id: "iot-l8", title: "IoT Gateway Lab", duration: "60 min", type: "lab" as const, completed: false },
        ],
      },
      {
        id: "iot-m3",
        ...
        duration: "3 hours",
        lessons: [
          { id: "iot-l9", title: "IoT Attack Vectors", duration: "25 min", type: "video" as const, completed: false },
          { id: "iot-l10", title: "Device Authentication & PKI for IoT", duration: "20 min", type: "video" as const, completed: false },
          { id: "iot-l11", title: "Network Micro-Segmentation", duration: "20 min", type: "video" as const, completed: false },
          { id: "iot-l12", title: "IoT Quiz", duration: "20 min", type: "quiz" as const, completed: false },
        ],
      },
    ],
    prerequisites: ["ccna-complete", "network-security-core"],
    skills: ["MQTT", "CoAP", "LoRaWAN", "Edge Computing", "IoT Security", "Network Segmentation"],
    relatedLabs: [],
    relatedQuizzes: [],
  },
];
