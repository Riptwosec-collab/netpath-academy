...
export const metadata: Metadata = {
  title: "AI/GPU Infrastructure Hardware | Hardware | NetPath Academy",
};
...
export default function AiGpuHwPage() {
  const category = hardwareCategories.find(c => c.id === "ai-gpu");
    ...
    <div className="min-h-screen bg-[#050816] text-gray-200 p-6 md:p-10">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
          ...
          <span>/</span>
          <span className="text-gray-300">AI/GPU Infrastructure Hardware</span>
        </div>

        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">🤖 AI/GPU Infrastructure Hardware</h1>
          <p className="text-gray-400">GPU Server, NVLink, RDMA NIC, DPU, 400G</p>
        </div>
