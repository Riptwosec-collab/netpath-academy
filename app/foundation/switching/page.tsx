...
export const metadata: Metadata = {
  title: "Switching | Foundation | NetPath Academy",
};
...
export default function SwitchingPage() {
  const category = foundationCategories.find(c => c.id === "switching");
  ...
  return (
    <div className="min-h-screen bg-[#050816] text-gray-200 p-6 md:p-10">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">🔀 Switching</h1>
          <p className="text-gray-400">VLAN, Trunk, STP, EtherChannel</p>
        </div>
