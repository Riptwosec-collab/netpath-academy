...
export const metadata: Metadata = {
  title: "Routing | Foundation | NetPath Academy",
};
...
export default function RoutingPage() {
  const category = foundationCategories.find(c => c.id === "routing");
  ...
  return (
    <div className="min-h-screen bg-[#050816] text-gray-200 p-6 md:p-10">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">🗺️ Routing</h1>
          <p className="text-gray-400">OSPF, EIGRP, BGP, Static Route</p>
        </div>
