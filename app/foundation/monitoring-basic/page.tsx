...
export const metadata: Metadata = {
  title: "Monitoring Basic | Foundation | NetPath Academy",
};
...
export default function MonitoringBasicPage() {
  const category = foundationCategories.find(c => c.id === "monitoring");
    ...
    <div className="min-h-screen bg-[#050816] text-gray-200 p-6 md:p-10">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
          ...
          <span>/</span>
          <span className="text-gray-300">Monitoring Basic</span>
        </div>

        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">📊 Monitoring Basic</h1>
          <p className="text-gray-400">SNMP, Syslog, NetFlow</p>
        </div>
