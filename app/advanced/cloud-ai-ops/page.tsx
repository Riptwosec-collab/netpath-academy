...
export const metadata: Metadata = {
  title: "Cloud Native & AI Ops | Advanced | NetPath Academy",
};
...
export default function CloudAiOpsPage() {
  const track = advancedTracks.find(t => t.id === "cloud-ai-ops");

  return (
    <div className="min-h-screen bg-[#050816] text-gray-200 p-6 md:p-10">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
          <Link href="/advanced" className="hover:text-cyan-400 transition-colors">Advanced</Link>
          <span>/</span>
          <span className="text-gray-300">Cloud Native & AI Ops</span>
        </div>

        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">☁️ Cloud Native & AI Ops</h1>
          <p className="text-gray-400">Kubernetes Networking, CNI, eBPF, Cilium, Observability</p>
          {track && (
        ...
        <div className="mt-8 flex gap-4">
          <Link href="/advanced" className="text-sm text-gray-500 hover:text-cyan-400 transition-colors">
            ← กลับ Advanced
          </Link>
